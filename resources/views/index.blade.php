        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p>"Glasses are not just a window to clearer vision; they are a frame for the world's beauty, a
                        reflection of your unique style, and a reminder that sometimes, a different perspective is all
                        we need to see the extraordinary in the ordinary."</p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p>"Glasses are not just a lens to see the world; they are a frame to envision your unique
                        perspective, a statement of style, and a reflection of the clarity you seek in every moment of
                        life."</p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Chill Glasses</h5>
                    <p>"Glasses not only frame the world we see, but they also reveal the beauty in every detail,
                        turning vision into an art, and style into a statement."</p>
                </div>
            </div>
        </div>
    ...
    <section class="men-fashions" style="margin-top:10px">
        ...
        <div class="most-popular">
            ...
            <div class="row"> <!-- 3 -->
                ...
                <div class="price">
                    <h4>KACAMATA LENTUR (Anti Radiasi Photocromic Blueray Bluecromic) 2126 / bisa minus dan silinder
                    </h4>
                    <h3>Rp 140.000</h3>
                </div>
            </div>
        ...
        <div class="latest-product">
            ...
            <div class="row"> <!-- 1 -->
                ...
                <div class="price">
                    <h4>PL-H019 Kacamata Steampunk Hitam Bersepeda Cyberpunk Hip Hop Punk Gaya Retro Eropa Olahraga
                        Wanita
                        Dan Pria</h4>
                    <h3>Rp 80.000</h3>
                </div>
